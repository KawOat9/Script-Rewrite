...
(function () {
  ...
  function render() {
    ...
    if (location.host === "github.com") {
      // 仅保留 Raw + ScriptHub
      stack.appendChild(makeBtn("Open Raw", openRawLink, [0,200,83]));
      stack.appendChild(makeBtn("Open ScriptHub", openScriptHubLink, [156,39,176]));
    }

    if (/script\.hub|127\.0\.0\.1:9101/.test(location.host)) {
      stack.appendChild(makeBtn("Open Script-Hub Editor", reEditLink, [255,152,0]));
    }
  }
